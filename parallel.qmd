...
\
1. Duration: 10 minutes max\
2. File size: 100MB max\
3. Video file format: MP4\
4. Video resolution: Minimum 720p HD\
5. Use your own voice with clear background narration\
6. The audio must be audible and clear\
7. No background music is allowed in the video\
8. Name the video as the presenter’s name and the paper ID number (Example: AHMAD_000-000)\
9. The video should be uploaded to [https://forms.gle/Q4wkhkChQjhq8jjH8](https://forms.gle/Q4wkhkChQjhq8jjH8) before 15 January 2025\
\
**Note: Participants must use the iCMS2025 slide template provided.**\
\
\
**Download Guidelines**\
